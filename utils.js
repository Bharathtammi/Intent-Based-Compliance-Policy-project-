...
exports.find = function(node, type) {
  return node.nodes.find(node => node.type === type);
};

// Find a node of the given type
exports.exceedsLimit = function(min, max, step = 1, limit) {
...
exports.escapeNode = function(block, n = 0, type) {
